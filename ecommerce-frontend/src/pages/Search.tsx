...
const Search = () => {
    ...
    return (
        <div className="product-search-page">
            <aside>
                ...
                <div>
                    ...
                    <select value={category} onChange={(e) => setCategory(e.target.value)}>
                        ...
                        {
                            !loadingCategories && categoriesResponse?.categories.map((category, i) => (
            ...
            <main>
                <h1 style={{ paddingLeft: "30px"}}>Products</h1>
                ...
                {productLoading ? (
                    ...
                    <div className="search-product-list">
                        {searchedData?.products.map((i) => (
                            ...
                            category={i.category} price={i.price} stock={i.stock} handler={addToCartHandler} photo={i.photo} />
                        ))}
                    </div>
                )}
